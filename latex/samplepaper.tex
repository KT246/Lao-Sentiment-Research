...
A closely related regional example is Vietnamese e-commerce sentiment classification, where recent work reports strong results from fine-tuning PhoBERT, viBERT, and XLM-RoBERTa variants while also highlighting informal language, code-mixing, and domain-adaptation challenges that are relevant to our setting \cite{pham2026vietnamese_ecommerce}.
...
\begin{table}[H]
\centering
\caption{Comparison of preprocessing results between Processed Data and Original Data, illustrating common Lao script errors identified during cleaning. Red text marks the incorrect span in Processed Data, while blue text marks the corrected span in Original Data.}
\small
\renewcommand{\arraystretch}{1.3}
\begin{tabularx}{\textwidth}{|p{0.24\textwidth}|X|X|X|}
\hline
\textbf{Error Description} & \textbf{Processed Data (version 1)} & \textbf{Original Data} & \textbf{English Content} \\
\hline
Vowel error \& missing a letter:\newline \textcolor{teal!70!black}{\textbf{(1)}} {\tablelaofont ຢຸ} $\rightarrow$ {\tablelaofont ຢູ່}: missing long-vowel sign + tone mark & {\tablelaofont ກະດີ\textcolor{red!75!black}{ຢຸ}} \textcolor{teal!70!black}{\textbf{(1)}} & {\tablelaofont ກະດີ\textcolor{blue!70!black}{ຢູ່}} & it is good \\
\hline
Incorrect label \& character error:\newline \textcolor{teal!70!black}{\textbf{(2)}} {\tablelaofont ບໍ} $\rightarrow$ {\tablelaofont ບໍ່}: missing tone mark; label mismatch & {\tablelaofont \textcolor{red!75!black}{ບໍ}ມີຫຍັງ} \textcolor{teal!70!black}{\textbf{(2)}} & {\tablelaofont \textcolor{blue!70!black}{ບໍ່}ມີຫຍັງ} & no problem \\
\cline{2-4}
\textcolor{teal!70!black}{\textbf{(3)}} {\tablelaofont ໃສ່} $\rightarrow$ {\tablelaofont ໃຊ້}: wrong middle word; label mismatch & {\tablelaofont ພໍ\textcolor{red!75!black}{ໃສ່}ໄດ້} \textcolor{teal!70!black}{\textbf{(3)}} & {\tablelaofont ພໍ\textcolor{blue!70!black}{ໃຊ້}ໄດ້} & enough to use \\
\cline{2-4}
\textcolor{teal!70!black}{\textbf{(4)}} {\tablelaofont ໃດ້} $\rightarrow$ {\tablelaofont ໄດ້}: wrong leading vowel sign; label mismatch & {\tablelaofont ຕິດຕັ້ງບໍ່\textcolor{red!75!black}{ໃດ້}} \textcolor{teal!70!black}{\textbf{(4)}} & {\tablelaofont ຕິດຕັ້ງບໍ່\textcolor{blue!70!black}{ໄດ້}} & cannot install \\
\cline{2-4}
\textcolor{teal!70!black}{\textbf{(5)}} {\tablelaofont ໄຈ} $\rightarrow$ {\tablelaofont ໃຈ}: wrong leading vowel sign; label mismatch & {\tablelaofont ຂອບ\textcolor{red!75!black}{ໄຈ}} \textcolor{teal!70!black}{\textbf{(5)}} & {\tablelaofont ຂອບ\textcolor{blue!70!black}{ໃຈ}} & thank you \\
\hline
