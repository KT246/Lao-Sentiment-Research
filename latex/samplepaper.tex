...
\begin{table}[!htbp]
\centering
\caption{Train and validation statistics after filtering and preprocessing.}
\footnotesize
\setlength{\tabcolsep}{4pt}
\renewcommand{\arraystretch}{1.08}
\begin{tabularx}{\textwidth}{@{}>{\raggedright\arraybackslash}X>{\raggedleft\arraybackslash}p{0.11\textwidth}>{\raggedleft\arraybackslash}p{0.11\textwidth}>{\raggedright\arraybackslash}X>{\raggedleft\arraybackslash}p{0.11\textwidth}>{\raggedleft\arraybackslash}p{0.11\textwidth}@{}}
\toprule
\textbf{Statistic} & \textbf{Train} & \textbf{Val.} & \textbf{Statistic} & \textbf{Train} & \textbf{Val.} \\
\midrule
