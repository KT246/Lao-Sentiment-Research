...
The evolution of Lao sentiment analysis has followed the broader trajectory of PLM development and low-resource adaptation, spanning general multilingual baselines and dedicated Lao-specific benchmarks.
...
\begin{table}[H]
\centering
\caption{Efficiency comparison between full fine-tuning (FT) and LoRA.}
\small
\renewcommand{\arraystretch}{1.15}
\setlength{\tabcolsep}{4pt}
\begin{tabular}{|p{0.20\textwidth}|p{0.07\textwidth}|r|r|r|r|r|}
\hline
\textbf{Model Family} & \textbf{Strat.} & \textbf{Params} & \textbf{Ratio} & \textbf{Epoch (s)} & \textbf{Total (min)} & \textbf{$F_1$} \\
\hline
{\textbf{XLM-RoBERTa}}
