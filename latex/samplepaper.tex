...
Lao constitutes a tonal linguistic system characterized by an orthographic depth that departs fundamentally from the linear, segment-delimited paradigms of Latinate scripts. As an abugida, the Lao script employs a non-linear graphemic topology where vowels and tonemic diacritics are spatially distributed relative to a primary consonant nucleus. This configuration presents substantial obstacles for computational sentiment analysis, as the absence of explicit whitespace complicates morphological parsing and increases semantic entropy \cite{enfield2008grammar,lew2014linguistic}. The phonological foundation of Lao is anchored in the tri-partite classification of consonants-High, Mid, and Low registers-which serve as the phonetic anchors for tonogenesis. Furthermore, the positional variability of vowels, which may be preposed, postposed, superposed, or subposed, introduces significant encoding noise in informal digital text where characters often appear in visual rather than logical sequences.

Beyond synchronic graphetics, the tonogenetic evolution of Lao has produced a complex mapping where surface-level pitch contours emerge from the synergistic interaction of consonant class, syllable weight (live vs. dead), and explicit tone markers \cite{pittayaporn2009phonology}. In the colloquial registers of user reviews, these markers are frequently omitted or substituted by phonological approximations, leading to considerable polarity ambiguity. Tables~\ref{tab:lao_graphetics} and \ref{tab:lao_tonogenesis} provide a consolidated overview of the graphetic properties and tonogenetic constraints governing the Vientiane (standard) dialect, illustrating the dense linguistic logic that PLMs must reconstruct to achieve high-fidelity classification in this low-resource setting.

\begin{table}[H]
\centering
\caption{Lao Linguistic Framework: Tonogenetic Rules (Interactive Determination).}
\footnotesize
...
\begin{table}[H]
\centering
\caption{Lao Linguistic Framework: Graphetic Architectonics (Consonants and Vowels).}
\footnotesize
\renewcommand{\arraystretch}{1.3}
\begin{tabularx}{\textwidth}{|l|X|X|X|X|X|}
\hline
\textbf{Register} & \multicolumn{5}{l|}{\textbf{Consonant Graphemes}} \\
\hline
High & \multicolumn{5}{l|}{{\tablelaofont ຂ, ສ, ຖ, ຜ, ຝ, ຫ}} \\
\hline
Middle & \multicolumn{5}{l|}{{\tablelaofont ກ, ຈ, ດ, ຕ, ບ, ປ, ຢ, ອ}} \\
\hline
Low & \multicolumn{5}{l|}{{\tablelaofont ຄ, ງ, ຊ, ຍ, ທ, ນ, ພ, ຟ, ມ, ລ, ວ, ຮ}} \\
\hline
\hline
\textbf{Topology} & \multicolumn{2}{l|}{\textbf{Vowel Graphemes}} & \multicolumn{3}{l|}{\textbf{Spatial Relation to Nucleus}} \\
\hline
Preposed & \multicolumn{2}{l|}{{\tablelaofont ເ, ແ, ໂ, ໃ, ໄ}} & \multicolumn{3}{l|}{Antecedent (Before)} \\
\hline
Postposed & \multicolumn{2}{l|}{{\tablelaofont ະ, າ, ຳ}} & \multicolumn{3}{l|}{Subsequent (After)} \\
\hline
Superposed & \multicolumn{2}{l|}{{\tablelaofont ◌ິ, ◌ີ, ◌ຶ, ◌ື, ◌ໍ}} & \multicolumn{3}{l|}{Superjacent (Above)} \\
\hline
Subposed & \multicolumn{2}{l|}{{\tablelaofont ◌ຸ, ◌ູ}} & \multicolumn{3}{l|}{Subjacent (Below)} \\
\hline
\end{tabularx}
...
\hline
\textbf{Error Description} & \textbf{Processed Data (version 1)} & \textbf{Standard Lao} & \textbf{English Meaning} \\
\hline
